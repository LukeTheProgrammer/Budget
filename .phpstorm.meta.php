...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'transactions.default_account_id' => 'string',
...
'session.http_only','session.same_site','session.partitioned','session.serialization','transactions.default_account_id',
...
'passkeys.redirect','mcp.redirect_domains','mcp.custom_schemes','mcp.authorization_server','ide-helper.filename',
...
'session-period.update','budgets.index','budgets.update','transactions.index','transactions.import',
'transactions.tags.store','transactions.tags.destroy','tags.destroy','merchants.index','merchants.update',
'merchants.group','merchants.aliases.store','merchants.aliases.destroy','merchants.rules.store','merchants.rules.destroy',
'merchants.default-tags.store','merchants.default-tags.destroy','profile.edit','profile.update',
'profile.destroy','security.edit','user-password.update','appearance.edit','storage.local',
...
'TRANSACTIONS_DEFAULT_ACCOUNT_ID',);
